            ...
            <div className="flex flex-col justify-center py-14 md:py-0 relative z-10">
                <div className="text-center md:text-left space-y-6 lg:max-w-[400px]">
                   <motion.h1 
                    ...
                    initial= "hidden"
                    animate="visible"
                   className="text-5xl lg:text-6xl font-bold leading-relaxed xl:leading-loose font-averia ">Heathy
                  <br/>
                    Fresh <span 
                    ...
                    initial= "hidden"
                    animate="visible"
                    className='text-2xl tracking-wide'>order Now For Fresh Heathy Life</motion.p>
                    <motion.p 
                       ...
                       className='text-gray-400'>
                        Healthy and Yummy food for fresh morning breakfast.
                         Eat Daily for good health and mind Order now and ger 
